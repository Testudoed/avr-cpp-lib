...
#ifndef __AVR_CPP_ATMEGA324P_SPI_H__
#define __AVR_CPP_ATMEGA324P_SPI_H__
...
#error "Include <avr/cpp/SPI.h> instead of <avr/cpp/atmega324p/SPI.h>"
#else
...
/**********************************************************************************************************************\
	...
	atmega324p serial peripheral interace (SPI) declarations.
