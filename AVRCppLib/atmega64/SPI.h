...
#ifndef __AVR_CPP_ATMEGA64_SPI_H__
#define __AVR_CPP_ATMEGA64_SPI_H__
...
#error "Include <avr/cpp/SPI.h> instead of <avr/cpp/atmega64/SPI.h>"
#else
...
/**********************************************************************************************************************\
	...
	atmega64 serial peripheral interace (SPI) declarations.
...
#endif // ifndef __AVR_CPP_ATMEGA64_SPI_H__
