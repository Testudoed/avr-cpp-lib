...
#ifndef __AVR_CPP_ATMEGA164P_IO_H__
#define __AVR_CPP_ATMEGA164P_IO_H__
...
#error "Include <avr/cpp/IO.h> instead of <avr/cpp/atmega164p/IO.h>"
#else

#ifndef __AVR_CPP_XXX_IO_H__
#define __AVR_CPP_XXX_IO_H__
#else
#error "Attempt to include more than one <avr/cpp/XXX/IO.h> file"
#endif
...
#endif // ifndef __AVR_CPP_ATMEGA164P_IO_H__
